    ...
    userAPI.getUserById(userId).then(res => {
      ...
      if (
        ...
        confirm = window.confirm(
          "Load your last unsubmitted workout from storage?"
        );
      }
      ...
      <div className="container pageContainer submitContainer liftContainer">
        <div>
          ...
          <div className="input-group input-group-sm mb-3">
            ...
            <p className="infoMsg">
              Only exercises containing "push-up", "pull-up", or "chin-up" count
              toward overall push-up/pull-up totals. Static holds are not
              counted.
            </p>
          </div>
          ...
          <div className="form-check">
            {this.state.muscleGroupList &&
            this.state.muscleGroupList.length > 0 ? (
          ...
          {/* {localStorage.getItem("userId") === "834292GU" ? (
            ...
            <button className="btn btn-primary" onClick={this.getTtlMins}>
              Submit
            </button>
          )} */}
        </div>
