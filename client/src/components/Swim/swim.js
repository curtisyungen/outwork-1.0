    ...
    return (
      <span>
        <div className="d-flex flex-row actCard" onClick={this.openModal}>
          ...
          <div className="cell">
            <span className="cellDesc">Meters</span>
            {this.props.distance}
          </div>
          ...
          <div className="cell cell5">
            <span className="cellDesc">Location</span>
            {this.props.location}
          </div>
          <div className="cell cell6">
            <span className="cellDesc">Water Type</span>
            {this.props.surface}
          </div>
          <div className="cell cell7">
            <span className="cellDesc">Laps</span>
            {this.props.laps}
          </div>
        ...
        {this.state.openModal ? (
          <Modal open={this.state.openModal} onClose={this.closeModal}>
            ...
            <div className="">
              <FontAwesomeIcon
                className="fa-3x swimIcon dataIcon"
                icon={faSwimmer}
              />
            ...
            <div>
              <div className="d-flex flex-column">
                ...
                <div className="border-bottom">
                  ...
                  <div className="">
                    {this.props.workout && this.props.workout.length > 0 ? (
                      JSON.parse(this.props.workout).map(lap => (
                        <div className="swimLapDiv">
                          <span className="swimLapModal">
