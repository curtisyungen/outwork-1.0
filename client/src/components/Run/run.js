    ...
    return (
      <span>
        <div className="d-flex flex-row actCard" onClick={this.openModal}>
          <div
            className={`runIcon border-${this.props.runType !== null &&
          ...
          <div className="cell">
            <span className="cellDesc">Miles</span>
            {this.props.distance}
          </div>
          ...
          <div className="cell cell5">
            <span className="cellDesc">Mile Pace</span>
            {this.props.milePace}
          </div>
          <div className="cell cell6">
            <span className="cellDesc">Climb</span>
            {this.props.climb}
          </div>
          <div className="cell cell7">
            <span className="cellDesc">Weather</span>
            {this.props.weather}
          </div>
        ...
        {this.state.openModal ? (
          <Modal open={this.state.openModal} onClose={this.closeModal}>
            ...
            <div className="">
              <FontAwesomeIcon
                className="fa-3x runIcon dataIcon"
                icon={faRunning}
              />
            ...
            <div>
              <div className="d-flex flex-column">
                    ...
                    <div className="">
                      {JSON.parse(this.props.repeats).map(repeat => (
                        <div key={repeat.id} className="repeatDiv">
                          <span className="repeatSpan">
                            Miles: {repeat.distance}
                          </span>
                          <span className="repeatSpan">
                            Time: {repeat.time}
                          </span>
                ...
                <div className="border-bottom">
                  ...
                  <div className="dataPoint dataPoint-map">
                    {this.props.map}
                  </div>
                </div>
              </div>
